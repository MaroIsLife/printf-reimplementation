...
void aprintspace(va_list args, int *i, const char *num)
{
    ...
    if (h < 0)
        *i = *i + mwhichspace(num, n, args, h) + mcounter2(num, z) + acounter(num, z) + zcounter2(num, z) + 1;
    else if (num[z] == '0')
        *i = *i + zwhichspace(num, n, args, h) + zcounter2(num, z) + acounter(num, z) + mcounter2(num, z) + 1;
    else if (num[z] == '-')
         *i = *i + mwhichspace(num, n, args, h) + mcounter2(num, z) + acounter(num, z) + zcounter2(num, z) + 1;
    else
...
void printspace(va_list args, int *i, const char *num)
{
    ...
    free(s);
    if (num[z] == '0')
        *i = *i + zwhichspace(num, n, args, h) + zcounter2(num, z) + count(h) + 1;
    else if (num[z] == '-')
        *i = *i + mwhichspace(num, n, args, h) + mcounter2(num, z) + count(h) + 1;
    else
